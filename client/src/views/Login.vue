...
<template>
  <main
    class="login min-h-screen bg-gradient-to-br from-purple-800 to-blue-500"
  >
    <section class="container mx-auto pt-16 pb-4 px-4">
      ...
      >
        <label class="block mb-2">
          <div class="text-gray-400 mb-2">Enter your email address</div>
          <input
            type="email"
        ...
        <div class="flex justify-end items-center">
          <input
            ...
            value="Login"
            :disabled="isSubmitting"
            class="inline-block bg-violet-500 text-lg text-gray-800 font-bold uppercase rounded px-4 py-2 cursor-pointer disabled:opacity-50"
          />
        </div>
      </form>
    </section>
